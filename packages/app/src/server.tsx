...
export default eventHandler(async event => {
  ...
  let assets = (await clientManifest.inputs[clientManifest.handler].assets()).filter((d: any) => {
  ...
  return new Response(transformedStream as any, {
    ...
    statusText: `${router.state.statusCode}`.startsWith('5') ? 'Internal Server Error' : 'OK',
    headers
  })
})
